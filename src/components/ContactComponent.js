...
class Contact extends Component {
    ...
    constructor(props) {
        ...
        // this.state = {           removed because of react-redux-form
        //     firstname: '',
        //     lastname: '',
        //     telnum: '',
        //     email: '',
                    ...
                    <div className="col-12 col-md-9">
                        <Form model="feedback" onSubmit={(values) => this.handleSubmit(values)}>
                                ...
                                <Col md={10}>
                                    ...
                                    <Errors
                                        ...
                                        messages={{
                                            ...
                                            isNumber: 'Must be numeric value'
                                        }}
                                    />
                                </Col>
                            </Row>
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.textarea model=".message" id="message" className="form-control" rows="12" name="message" />
                                </Col>
                            </Row>
